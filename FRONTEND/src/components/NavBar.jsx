...
function NavBar() {
    return(
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <Link to="/" style={{textDecoration: "none"}}> <a class="navbar-brand">Proyecto 2</a>
                </Link>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <Link to="/interfaz" style={{textDecoration: "none"}}> <a class="nav-link active" aria-current="analisis">Interfaz Gráfica</a>
                </Link>
